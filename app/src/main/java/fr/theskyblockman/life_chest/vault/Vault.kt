...
import fr.theskyblockman.life_chest.explorer.SortMethod
import fr.theskyblockman.life_chest.unlock_mechanisms.UnlockMechanism
import fr.theskyblockman.life_chest.vault.Crypto.DEFAULT_CIPHER_NAME
...
data class Vault(
    ...
    companion object {
        const val ASK_TO_CLOSE_CHANNEL_ID = "fr.theskyblockman.life_chest/ask_to_close_chest"
    ...
    fun onSetBackground(context: Context) {
        ...
        when (encryptionLevel.toInt()) {
            ...
            0x01 -> {
                val intent = Intent("fr.theskyblockman.life_chest.close_chest")
