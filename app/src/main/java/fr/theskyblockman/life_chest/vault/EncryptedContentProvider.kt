...
import fr.theskyblockman.life_chest.vault.EncryptedContentProvider.Companion.vault
 ...
 * Here's the scheme:
 * ```plain
 * content://fr.theskyblockman.life_chest.encryptedfiles/<vault-id>/<file-id>
 * ```
 *
...
class EncryptedContentProvider : ContentProvider() {
    companion object {
        ...
        // Could be
        // - fr.theskyblockman.life_chest.encryptedfiles
        // - fr.theskyblockman.life_chest.debug.encryptedfiles
